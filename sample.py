...
from aliyun.log.index_config import IndexConfig, IndexKeyConfig
from aliyun.log.index_config import IndexLineConfig
from aliyun.log.logtail_config_detail import CommonRegLogConfigDetail
...
def sample_machine_group(client, project):
    ...
    machine_group = MachineGroupDetail(
        "sample-group", "ip", ["127.0.0.1", "127.0.0.2"],
        "Armory", {"externalName": "test-1", "groupTopic": "yyy"})
...
def sample_logtail_config(client, project, logstore):
    logtail_config = CommonRegLogConfigDetail(
        "stt1-logtail", logstore,
...
def sample_apply_config(client, project):
    ...
    res = client.apply_config_to_machine_group(
        project, "stt1-logtail", "sample-group")
    res.log_print()
