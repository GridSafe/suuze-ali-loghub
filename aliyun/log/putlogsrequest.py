...
class PutLogsRequest(LogRequest):
    ...
    :type hashKey : String
    :param hashKey : put data with set hash, the data will be send to
                     shard whose range contains the hashKey
    """

    def __init__(self, project=None, logstore=None, topic=None, source=None,
                 logitems=None, hashKey=None, compress=False):
